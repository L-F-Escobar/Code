...
'''
    Script will write to text file publicGetMarketHistory the latest trades
    that have occured for the market key pair parameter. Further, the script
    isolates all endpoint data in a manner which makes it easily retreivable
    and accessable. 
'''

# Example of passed in market parameter. Endpoint URL must have a market
# parameter.
market = 'market=BTC-DASH'

# Endpoint url. Endpoint URL must have a market parameter. This is an example
# usning btc-dash parameters.
url = "https://bittrex.com/api/v1.1/public/getmarkethistory?" + market
